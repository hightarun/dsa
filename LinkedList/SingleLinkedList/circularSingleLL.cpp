...
void singleCLL::create_node(int value)
{
    struct node *temp;
...
void singleCLL::add_begin(int value)
{
    if (last == NULL)
    {
...
void singleCLL::add_after(int value, int pos)
{
    if (last == NULL)
    {
        cout << "First Create the list." << endl;
...
void singleCLL::delete_element(int value)
{
    struct node *temp, *s;
    s = last->next;
...
void singleCLL::search_element(int value)
{
    struct node *s;
    int counter = 0;
    s = last->next;
